...
function updateFromPolicyResult(appId, channel, result) {
  ...
  // API returns policy:"safety_analysis", "student_monitor", or policy_name:"agora_safety_analysis"
  const isSafety = result.policy_name === 'agora_safety_analysis' || result.policy === 'safety_analysis' || result.policy === 'student_monitor';
  if (isSafety) {

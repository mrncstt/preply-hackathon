    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#FF7AAC' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-sm" style={{ color: 'rgba(255,255,255,0.7)' }}>
              Around 90 seconds voice interview. Personalized results.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <StepCard
              ...
              description="Our AI Discovery Coach asks about your passions, goals, and learning style in a natural around 90 seconds voice conversation."
              color="#FF7AAC"
            />
            <StepCard
              number="2"
      ...
      <footer style={{ background: '#121117', color: '#9CA3AF' }}>
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="mt-6 pt-6 text-xs flex items-center justify-between" style={{ borderTop: '1px solid #2a2a2a' }}>
            <span>Hackathon prototype. Built at Preply x Agora Hackathon, Barcelona 2026.</span>
            <a href="https://github.com/mrncstt/preply-hackathon" target="_blank" className="flex items-center gap-1.5 hover:text-white transition-colors no-underline" style={{ color: '#9CA3AF' }}>

      ...
      <nav className="flex items-center justify-between px-6 py-3 max-w-7xl mx-auto w-full" style={{ background: '#FF7AAC' }}>
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-4 text-sm font-semibold" style={{ color: '#121117' }}>
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" className="cursor-pointer hover:opacity-70 no-underline" style={{ color: '#fff' }}>Find tutors</a>
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" className="cursor-pointer hover:opacity-70 no-underline" style={{ color: '#fff' }}>For business</a>
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" className="cursor-pointer hover:opacity-70 no-underline" style={{ color: '#fff' }}>Become a tutor</a>
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" className="cursor-pointer hover:opacity-70 no-underline" style={{ color: '#fff' }}>Proven Progress</a>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-1 text-sm cursor-pointer hover:opacity-70" style={{ color: '#fff' }}>
            <Globe className="w-4 h-4" />
            <span>EN</span>
          </div>
          <button className="px-4 py-2 rounded-lg text-sm font-medium hover:opacity-70" style={{ color: '#fff' }}>
            Log in
          </button>

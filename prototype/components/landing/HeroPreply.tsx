    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <nav className="flex items-center justify-between px-6 py-3 max-w-7xl mx-auto w-full" style={{ borderBottom: '1px solid #E8E8E8' }}>
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" className="px-5 py-2.5 rounded-lg text-white text-sm font-semibold hover:brightness-110 transition-all no-underline" style={{ background: '#018058' }}>
            Sign up
          </a>
        </div>
      </nav>
